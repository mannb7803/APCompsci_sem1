...
public class GameMenu2 extends Application {
    ...
    public void start(Stage primaryStage) throws Exception
    {
        ...
        InputStream is = Files.newInputStream(Paths.get("res/images/1.jpg"));
        ...
        window.getChildren().addAll(imgView, gameMenu);
    ...
    public class Menu extends Parent {
        public Menu()
        {
            ...
            MenuButton btnOptions2 = new MenuButton("Options");
            btnOptions.setOnMouseClicked(event -> {
            ...
            MenuButton btnexit2 = new MenuButton("Exit");
            btnexit.setOnMouseClicked(event -> {
                System.exit(0);
            });
            ...
            menu3.getChildren().addAll(btnResume, btnOptions2, btnexit2);
